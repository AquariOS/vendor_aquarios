...
PRODUCT_COPY_FILES += \
   vendor/aquarios/prebuilt/common/etc/sysconfig/nexus.xml:system/etc/sysconfig/nexus.xml
...
PRODUCT_PACKAGE_OVERLAYS += vendor/aquarios/overlay/common
 ...
 # Bootanimation
$(call inherit-product, vendor/aquarios/prebuilt/common/bootanimation/bootanimation.mk)
